...
#ifndef ANSI_C
void givens(x, y, c, s) double x, y;
Real *c, *s;
#else
...
#ifndef ANSI_C
VEC *rot_vec(x, i, k, c, s, out) VEC *x, *out;
unsigned int i, k;
double c, s;
#else
...
#ifndef ANSI_C
MAT *rot_rows(mat, i, k, c, s, out) MAT *mat, *out;
unsigned int i, k;
double c, s;
#else
MAT *rot_rows(const MAT *mat, unsigned int i, unsigned int k, double c,
              double s, MAT *out)
#endif
{
  unsigned int j;
...
#ifndef ANSI_C
MAT *rot_cols(mat, i, k, c, s, out) MAT *mat, *out;
unsigned int i, k;
double c, s;
#else
MAT *rot_cols(const MAT *mat, unsigned int i, unsigned int k, double c,
              double s, MAT *out)
#endif
{
  unsigned int j;
