...
#ifndef ANSI_C
VEC *Usolve(matrix, b, out, diag) MAT *matrix;
VEC *b, *out;
double diag;
#else
...
#ifndef ANSI_C
VEC *Lsolve(matrix, b, out, diag) MAT *matrix;
VEC *b, *out;
double diag;
#else
...
#ifndef ANSI_C
VEC *UTsolve(U, b, out, diag) MAT *U;
VEC *b, *out;
double diag;
#else
...
/* LTsolve -- back substitution with optional over-riding diagonal
                ...
                -- can be in-situ but doesn't need to be */
#ifndef ANSI_C
VEC *LTsolve(L, b, out, diag) MAT *L;
VEC *b, *out;
double diag;
#else
