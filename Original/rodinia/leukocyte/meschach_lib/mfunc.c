...
#ifndef ANSI_C
MAT *_m_pow(A, p, tmp, out) MAT *A, *tmp, *out;
int p;
#else
...
*/
#ifndef ANSI_C
MAT *_m_exp(A, eps, out, q_out, j_out) MAT *A, *out;
double eps;
int *q_out, *j_out;
#else
