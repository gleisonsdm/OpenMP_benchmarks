...
#ifndef ANSI_C
IVEC *iv_resize(iv, new_dim) IVEC *iv;
int new_dim;
#else
...
#ifndef ANSI_C
IVEC *iv_copy(in, out) IVEC *in, *out;
#else
...
#ifndef ANSI_C
IVEC *iv_move(in, i0, dim0, out, i1) IVEC *in, *out;
int i0, dim0, i1;
#else
...
#ifndef ANSI_C
IVEC *iv_add(iv1, iv2, out) IVEC *iv1, *iv2, *out;
#else
...
#ifndef ANSI_C
IVEC *iv_sub(iv1, iv2, out) IVEC *iv1, *iv2, *out;
#else
