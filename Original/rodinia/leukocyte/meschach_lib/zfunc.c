...
complex zmake(real, imag) double real, imag;
{
...
#ifndef zadd
/* zadd -- returns z1+z2 */
complex zadd(z1, z2) complex z1, z2;
{
  complex z;
...
#ifndef zsub
/* zsub -- returns z1-z2 */
complex zsub(z1, z2) complex z1, z2;
{
  complex z;
...
#ifndef zmlt
/* zmlt -- returns z1*z2 */
complex zmlt(z1, z2) complex z1, z2;
{
  complex z;
