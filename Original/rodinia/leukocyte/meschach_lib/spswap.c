...
#ifndef ANSI_C
void scan_to(A, scan_row, scan_idx, col_list, max_row) SPMAT *A;
...
#ifndef ANSI_C
void patch_col(A, col, old_row, old_idx, row_num, idx) SPMAT *A;
...
#ifndef ANSI_C
row_elt *chase_col(A, col, row_num, idx, max_row) SPMAT *A;
int col, *row_num, *idx, max_row;
#else
row_elt *chase_col(const SPMAT *A, int col, int *row_num, int *idx, int max_row)
#endif
{
...
#ifndef ANSI_C
row_elt *chase_past(A, col, row_num, idx, min_row) SPMAT *A;
...
#ifndef ANSI_C
row_elt *bump_col(A, col, row_num, idx) SPMAT *A;
int col, *row_num, *idx;
#else
