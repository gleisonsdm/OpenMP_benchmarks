...
static void evolve(dcomplex u0[NZ][NY][NX], dcomplex u1[NZ][NY][NX], int t,
...
static void fftz2(int is, int l, int m, int n, int ny, int ny1, dcomplex u[NX],
...
#pragma omp master
  ...
  c_print_results("FT", class, NX, NY, NZ, niter, nthreads, total_time, mflops,
