...
static void blts(int nx, int ny, int nz, int k, double omega,
                 ...
                 double ldz[ISIZ1][ISIZ2][5][5], double ldy[ISIZ1][ISIZ2][5][5],
                 double ldx[ISIZ1][ISIZ2][5][5], double d[ISIZ1][ISIZ2][5][5],
                 int ist, int iend, int jst, int jend, int nx0, int ny0);
static void buts(int nx, int ny, int nz, int k, double omega,
                 double v[ISIZ1][ISIZ2 / 2 * 2 + 1][ISIZ3 / 2 * 2 + 1][5],
                 double tv[ISIZ1][ISIZ2][5], double d[ISIZ1][ISIZ2][5][5],
                 double udx[ISIZ1][ISIZ2][5][5], double udy[ISIZ1][ISIZ2][5][5],
                 double udz[ISIZ1][ISIZ2][5][5], int ist, int iend, int jst,
                 int jend, int nx0, int ny0);
...
static void verify(double xcr[5], double xce[5], double xci, char *class,
                   boolean *verified);
...
blts(int nx, int ny, int nz, int k, double omega,
     ...
     double v[ISIZ1][ISIZ2 / 2 * 2 + 1][ISIZ3 / 2 * 2 + 1][5],
     double ldz[ISIZ1][ISIZ2][5][5], double ldy[ISIZ1][ISIZ2][5][5],
     double ldx[ISIZ1][ISIZ2][5][5], double d[ISIZ1][ISIZ2][5][5], int ist,
...
#pragma omp flush(flag)
    ...
    for (j = jst; j <= jend; j++) {
      ...
      v[i][j][k][2] = v[i][j][k][2] - tmat[2][3] * v[i][j][k][3] -
                      tmat[2][4] * v[i][j][k][4];
      v[i][j][k][2] = v[i][j][k][2] / tmat[2][2];

      v[i][j][k][1] = v[i][j][k][1] - tmat[1][2] * v[i][j][k][2] -
                      tmat[1][3] * v[i][j][k][3] - tmat[1][4] * v[i][j][k][4];
      v[i][j][k][1] = v[i][j][k][1] / tmat[1][1];

      v[i][j][k][0] = v[i][j][k][0] - tmat[0][1] * v[i][j][k][1] -
...
buts(int nx, int ny, int nz, int k, double omega,
     ...
     double tv[ISIZ1][ISIZ2][5], double d[ISIZ1][ISIZ2][5][5],
     double udx[ISIZ1][ISIZ2][5][5], double udy[ISIZ1][ISIZ2][5][5],
     double udz[ISIZ1][ISIZ2][5][5], int ist, int iend, int jst, int jend,
     int nx0, int ny0) {
  /*--------------------------------------------------------------------
  c
...
#pragma omp for nowait schedule(static)
  for (i = iend; i >= ist; i--) {
    for (j = jend; j >= jst; j--) {
      for (m = 0; m < 5; m++) {
        tv[i][j][m] = omega * (udz[i][j][m][0] * v[i][j][k + 1][0] +
...
#pragma omp flush(flag)
    ...
    for (j = jend; j >= jst; j--) {
      ...
      tv[i][j][2] =
          tv[i][j][2] - tmat[2][3] * tv[i][j][3] - tmat[2][4] * tv[i][j][4];
    ...
    for (i = 0; i < nx; i++) {
      ...
      for (j = 0; j < ny; j++) {
        ...
        for (k = 0; k < nz; k++) {
          ...
          for (m = 0; m < 5; m++) {
            rsd[i][j][k][m] =
                ce[m][0] + ce[m][1] * xi + ce[m][2] * eta + ce[m][3] * zeta +
    ...
    for (j = jst; j <= jend; j++) {
      for (k = 1; k <= nz - 2; k++) {
        ...
        for (i = ist; i <= iend; i++) {
          frct[i][j][k][0] =
              frct[i][j][k][0] +
              dx1 * tx1 * (rsd[i - 1][j][k][0] - 2.0 * rsd[i][j][k][0] +
                           rsd[i + 1][j][k][0]);
          frct[i][j][k][1] =
              frct[i][j][k][1] +
              tx3 * C3 * C4 * (flux[i + 1][j][k][1] - flux[i][j][k][1]) +
              dx2 * tx1 * (rsd[i - 1][j][k][1] - 2.0 * rsd[i][j][k][1] +
                           rsd[i + 1][j][k][1]);
          frct[i][j][k][2] =
              frct[i][j][k][2] +
              tx3 * C3 * C4 * (flux[i + 1][j][k][2] - flux[i][j][k][2]) +
              dx3 * tx1 * (rsd[i - 1][j][k][2] - 2.0 * rsd[i][j][k][2] +
                           rsd[i + 1][j][k][2]);
          frct[i][j][k][3] =
              frct[i][j][k][3] +
              tx3 * C3 * C4 * (flux[i + 1][j][k][3] - flux[i][j][k][3]) +
              dx4 * tx1 * (rsd[i - 1][j][k][3] - 2.0 * rsd[i][j][k][3] +
                           rsd[i + 1][j][k][3]);
          frct[i][j][k][4] =
              frct[i][j][k][4] +
              tx3 * C3 * C4 * (flux[i + 1][j][k][4] - flux[i][j][k][4]) +
              dx5 * tx1 * (rsd[i - 1][j][k][4] - 2.0 * rsd[i][j][k][4] +
                           rsd[i + 1][j][k][4]);
        }
        ...
        for (m = 0; m < 5; m++) {
          frct[1][j][k][m] = frct[1][j][k][m] -
                             dsspm * (+5.0 * rsd[1][j][k][m] -
                                      4.0 * rsd[2][j][k][m] + rsd[3][j][k][m]);
          frct[2][j][k][m] =
              frct[2][j][k][m] -
              dsspm * (-4.0 * rsd[1][j][k][m] + 6.0 * rsd[2][j][k][m] -
                       4.0 * rsd[3][j][k][m] + rsd[4][j][k][m]);
        }
        ...
        for (i = ist1; i <= iend1; i++) {
          for (m = 0; m < 5; m++) {
            frct[i][j][k][m] =
                frct[i][j][k][m] -
                dsspm * (rsd[i - 2][j][k][m] - 4.0 * rsd[i - 1][j][k][m] +
                         6.0 * rsd[i][j][k][m] - 4.0 * rsd[i + 1][j][k][m] +
                         rsd[i + 2][j][k][m]);
          }
        }
        ...
        for (m = 0; m < 5; m++) {
          frct[nx - 3][j][k][m] =
              frct[nx - 3][j][k][m] -
              dsspm * (rsd[nx - 5][j][k][m] - 4.0 * rsd[nx - 4][j][k][m] +
                       6.0 * rsd[nx - 3][j][k][m] - 4.0 * rsd[nx - 2][j][k][m]);
          frct[nx - 2][j][k][m] =
              frct[nx - 2][j][k][m] -
              dsspm * (rsd[nx - 4][j][k][m] - 4.0 * rsd[nx - 3][j][k][m] +
                       5.0 * rsd[nx - 2][j][k][m]);
        }
      }
    }
    ...
    for (i = ist; i <= iend; i++) {
      for (k = 1; k <= nz - 2; k++) {
        ...
        for (j = jst; j <= jend; j++) {
          frct[i][j][k][0] =
              frct[i][j][k][0] +
              dy1 * ty1 * (rsd[i][j - 1][k][0] - 2.0 * rsd[i][j][k][0] +
                           rsd[i][j + 1][k][0]);
          frct[i][j][k][1] =
              frct[i][j][k][1] +
              ty3 * C3 * C4 * (flux[i][j + 1][k][1] - flux[i][j][k][1]) +
              dy2 * ty1 * (rsd[i][j - 1][k][1] - 2.0 * rsd[i][j][k][1] +
                           rsd[i][j + 1][k][1]);
          frct[i][j][k][2] =
              frct[i][j][k][2] +
              ty3 * C3 * C4 * (flux[i][j + 1][k][2] - flux[i][j][k][2]) +
              dy3 * ty1 * (rsd[i][j - 1][k][2] - 2.0 * rsd[i][j][k][2] +
                           rsd[i][j + 1][k][2]);
          frct[i][j][k][3] =
              frct[i][j][k][3] +
              ty3 * C3 * C4 * (flux[i][j + 1][k][3] - flux[i][j][k][3]) +
              dy4 * ty1 * (rsd[i][j - 1][k][3] - 2.0 * rsd[i][j][k][3] +
                           rsd[i][j + 1][k][3]);
          frct[i][j][k][4] =
              frct[i][j][k][4] +
              ty3 * C3 * C4 * (flux[i][j + 1][k][4] - flux[i][j][k][4]) +
              dy5 * ty1 * (rsd[i][j - 1][k][4] - 2.0 * rsd[i][j][k][4] +
                           rsd[i][j + 1][k][4]);
        }
        ...
        for (m = 0; m < 5; m++) {
          frct[i][1][k][m] = frct[i][1][k][m] -
                             dsspm * (+5.0 * rsd[i][1][k][m] -
                                      4.0 * rsd[i][2][k][m] + rsd[i][3][k][m]);
          frct[i][2][k][m] =
              frct[i][2][k][m] -
              dsspm * (-4.0 * rsd[i][1][k][m] + 6.0 * rsd[i][2][k][m] -
                       4.0 * rsd[i][3][k][m] + rsd[i][4][k][m]);
        }
        ...
        for (j = jst1; j <= jend1; j++) {
          for (m = 0; m < 5; m++) {
            frct[i][j][k][m] =
                frct[i][j][k][m] -
                dsspm * (rsd[i][j - 2][k][m] - 4.0 * rsd[i][j - 1][k][m] +
                         6.0 * rsd[i][j][k][m] - 4.0 * rsd[i][j + 1][k][m] +
                         rsd[i][j + 2][k][m]);
          }
        }
        ...
        for (m = 0; m < 5; m++) {
          frct[i][ny - 3][k][m] =
              frct[i][ny - 3][k][m] -
              dsspm * (rsd[i][ny - 5][k][m] - 4.0 * rsd[i][ny - 4][k][m] +
                       6.0 * rsd[i][ny - 3][k][m] - 4.0 * rsd[i][ny - 2][k][m]);
          frct[i][ny - 2][k][m] =
              frct[i][ny - 2][k][m] -
              dsspm * (rsd[i][ny - 4][k][m] - 4.0 * rsd[i][ny - 3][k][m] +
                       5.0 * rsd[i][ny - 2][k][m]);
        }
      }
    }
    ...
    for (i = ist; i <= iend; i++) {
      for (j = jst; j <= jend; j++) {
        ...
        for (k = 1; k <= nz - 2; k++) {
          frct[i][j][k][0] =
              frct[i][j][k][0] +
              dz1 * tz1 * (rsd[i][j][k + 1][0] - 2.0 * rsd[i][j][k][0] +
                           rsd[i][j][k - 1][0]);
          frct[i][j][k][1] =
              frct[i][j][k][1] +
              tz3 * C3 * C4 * (flux[i][j][k + 1][1] - flux[i][j][k][1]) +
              dz2 * tz1 * (rsd[i][j][k + 1][1] - 2.0 * rsd[i][j][k][1] +
                           rsd[i][j][k - 1][1]);
          frct[i][j][k][2] =
              frct[i][j][k][2] +
              tz3 * C3 * C4 * (flux[i][j][k + 1][2] - flux[i][j][k][2]) +
              dz3 * tz1 * (rsd[i][j][k + 1][2] - 2.0 * rsd[i][j][k][2] +
                           rsd[i][j][k - 1][2]);
          frct[i][j][k][3] =
              frct[i][j][k][3] +
              tz3 * C3 * C4 * (flux[i][j][k + 1][3] - flux[i][j][k][3]) +
              dz4 * tz1 * (rsd[i][j][k + 1][3] - 2.0 * rsd[i][j][k][3] +
                           rsd[i][j][k - 1][3]);
          frct[i][j][k][4] =
              frct[i][j][k][4] +
              tz3 * C3 * C4 * (flux[i][j][k + 1][4] - flux[i][j][k][4]) +
              dz5 * tz1 * (rsd[i][j][k + 1][4] - 2.0 * rsd[i][j][k][4] +
                           rsd[i][j][k - 1][4]);
        }
        ...
        for (m = 0; m < 5; m++) {
          frct[i][j][1][m] = frct[i][j][1][m] -
                             dsspm * (+5.0 * rsd[i][j][1][m] -
                                      4.0 * rsd[i][j][2][m] + rsd[i][j][3][m]);
          frct[i][j][2][m] =
              frct[i][j][2][m] -
              dsspm * (-4.0 * rsd[i][j][1][m] + 6.0 * rsd[i][j][2][m] -
                       4.0 * rsd[i][j][3][m] + rsd[i][j][4][m]);
        }
        ...
        for (k = 3; k <= nz - 4; k++) {
          for (m = 0; m < 5; m++) {
            frct[i][j][k][m] =
                frct[i][j][k][m] -
                dsspm * (rsd[i][j][k - 2][m] - 4.0 * rsd[i][j][k - 1][m] +
                         6.0 * rsd[i][j][k][m] - 4.0 * rsd[i][j][k + 1][m] +
                         rsd[i][j][k + 2][m]);
          }
        }
        ...
        for (m = 0; m < 5; m++) {
          frct[i][j][nz - 3][m] =
              frct[i][j][nz - 3][m] -
              dsspm * (rsd[i][j][nz - 5][m] - 4.0 * rsd[i][j][nz - 4][m] +
                       6.0 * rsd[i][j][nz - 3][m] - 4.0 * rsd[i][j][nz - 2][m]);
          frct[i][j][nz - 2][m] =
              frct[i][j][nz - 2][m] -
              dsspm * (rsd[i][j][nz - 4][m] - 4.0 * rsd[i][j][nz - 3][m] +
                       5.0 * rsd[i][j][nz - 2][m]);
        }
      }
    }
...
#pragma omp for nowait schedule(static)
  for (i = ist; i <= iend; i++) {
    for (j = jst; j <= jend; j++) {
      ...
      d[i][j][1][0] = dt * 2.0 * (tx1 * (-r43 * c34 * tmp2 * u[i][j][k][1]) +
                                  ty1 * (-c34 * tmp2 * u[i][j][k][1]) +
                                  tz1 * (-c34 * tmp2 * u[i][j][k][1]));
      d[i][j][1][1] = 1.0 +
                      dt * 2.0 * (tx1 * r43 * c34 * tmp1 + ty1 * c34 * tmp1 +
                                  tz1 * c34 * tmp1) +
      ...
      d[i][j][2][0] = dt * 2.0 * (tx1 * (-c34 * tmp2 * u[i][j][k][2]) +
                                  ty1 * (-r43 * c34 * tmp2 * u[i][j][k][2]) +
                                  tz1 * (-c34 * tmp2 * u[i][j][k][2]));
      d[i][j][2][1] = 0.0;
      d[i][j][2][2] = 1.0 +
                      dt * 2.0 * (tx1 * c34 * tmp1 + ty1 * r43 * c34 * tmp1 +
                                  tz1 * c34 * tmp1) +
                      dt * 2.0 * (tx1 * dx3 + ty1 * dy3 + tz1 * dz3);
      d[i][j][2][3] = 0.0;
      d[i][j][2][4] = 0.0;

      d[i][j][3][0] = dt * 2.0 * (tx1 * (-c34 * tmp2 * u[i][j][k][3]) +
                                  ty1 * (-c34 * tmp2 * u[i][j][k][3]) +
                                  tz1 * (-r43 * c34 * tmp2 * u[i][j][k][3]));
      d[i][j][3][1] = 0.0;
      d[i][j][3][2] = 0.0;
      d[i][j][3][3] = 1.0 +
                      dt * 2.0 * (tx1 * c34 * tmp1 + ty1 * c34 * tmp1 +
                                  tz1 * r43 * c34 * tmp1) +
      ...
      a[i][j][1][0] =
          -dt * tz2 * (-(u[i][j][k - 1][1] * u[i][j][k - 1][3]) * tmp2) -
      ...
      a[i][j][2][0] =
          -dt * tz2 * (-(u[i][j][k - 1][2] * u[i][j][k - 1][3]) * tmp2) -
      ...
      a[i][j][3][0] =
          -dt * tz2 *
              (-(u[i][j][k - 1][3] * tmp1) * (u[i][j][k - 1][3] * tmp1) +
               0.50 * C2 * ((u[i][j][k - 1][1] * u[i][j][k - 1][1] +
      ...
      a[i][j][3][3] = -dt * tz2 * (2.0 - C2) * (u[i][j][k - 1][3] * tmp1) -
                      dt * tz1 * (r43 * c34 * tmp1) - dt * tz1 * dz4;
      a[i][j][3][4] = -dt * tz2 * C2;

      a[i][j][4][0] =
          -dt * tz2 * ((C2 * (u[i][j][k - 1][1] * u[i][j][k - 1][1] +
                              u[i][j][k - 1][2] * u[i][j][k - 1][2] +
                              u[i][j][k - 1][3] * u[i][j][k - 1][3]) *
                            tmp2 -
                        C1 * (u[i][j][k - 1][4] * tmp1)) *
      ...
      a[i][j][4][1] =
          -dt * tz2 * (-C2 * (u[i][j][k - 1][1] * u[i][j][k - 1][3]) * tmp2) -
          dt * tz1 * (c34 - c1345) * tmp2 * u[i][j][k - 1][1];
      a[i][j][4][2] =
          -dt * tz2 * (-C2 * (u[i][j][k - 1][2] * u[i][j][k - 1][3]) * tmp2) -
      ...
      a[i][j][4][3] =
          -dt * tz2 *
              (C1 * (u[i][j][k - 1][4] * tmp1) -
               0.50 * C2 * ((u[i][j][k - 1][1] * u[i][j][k - 1][1] +
                             u[i][j][k - 1][2] * u[i][j][k - 1][2] +
                             3.0 * u[i][j][k - 1][3] * u[i][j][k - 1][3]) *
                            tmp2)) -
          dt * tz1 * (r43 * c34 - c1345) * tmp2 * u[i][j][k - 1][3];
      a[i][j][4][4] = -dt * tz2 * (C1 * (u[i][j][k - 1][3] * tmp1)) -
      ...
      b[i][j][1][0] =
          -dt * ty2 * (-(u[i][j - 1][k][1] * u[i][j - 1][k][2]) * tmp2) -
      ...
      b[i][j][2][2] = -dt * ty2 * ((2.0 - C2) * (u[i][j - 1][k][2] * tmp1)) -
                      dt * ty1 * (r43 * c34 * tmp1) - dt * ty1 * dy3;
      b[i][j][2][3] = -dt * ty2 * (-C2 * (u[i][j - 1][k][3] * tmp1));
      b[i][j][2][4] = -dt * ty2 * C2;

      b[i][j][3][0] =
          -dt * ty2 * (-(u[i][j - 1][k][2] * u[i][j - 1][k][3]) * tmp2) -
      ...
      b[i][j][4][0] =
          -dt * ty2 * ((C2 * (u[i][j - 1][k][1] * u[i][j - 1][k][1] +
                              u[i][j - 1][k][2] * u[i][j - 1][k][2] +
                              u[i][j - 1][k][3] * u[i][j - 1][k][3]) *
                            tmp2 -
                        C1 * (u[i][j - 1][k][4] * tmp1)) *
                       (u[i][j - 1][k][2] * tmp1)) -
          dt * ty1 * (-(c34 - c1345) * tmp3 * (pow2(u[i][j - 1][k][1])) -
                      (r43 * c34 - c1345) * tmp3 * (pow2(u[i][j - 1][k][2])) -
                      (c34 - c1345) * tmp3 * (pow2(u[i][j - 1][k][3])) -
                      c1345 * tmp2 * u[i][j - 1][k][4]);
      b[i][j][4][1] =
          -dt * ty2 * (-C2 * (u[i][j - 1][k][1] * u[i][j - 1][k][2]) * tmp2) -
          dt * ty1 * (c34 - c1345) * tmp2 * u[i][j - 1][k][1];
      b[i][j][4][2] =
          -dt * ty2 *
              (C1 * (u[i][j - 1][k][4] * tmp1) -
               0.50 * C2 * ((u[i][j - 1][k][1] * u[i][j - 1][k][1] +
                             ...
                             u[i][j - 1][k][3] * u[i][j - 1][k][3]) *
                            tmp2)) -
          dt * ty1 * (r43 * c34 - c1345) * tmp2 * u[i][j - 1][k][2];
      b[i][j][4][3] =
          -dt * ty2 * (-C2 * (u[i][j - 1][k][2] * u[i][j - 1][k][3]) * tmp2) -
          dt * ty1 * (c34 - c1345) * tmp2 * u[i][j - 1][k][3];
      b[i][j][4][4] = -dt * ty2 * (C1 * (u[i][j - 1][k][2] * tmp1)) -
      ...
      c[i][j][1][1] = -dt * tx2 * ((2.0 - C2) * (u[i - 1][j][k][1] * tmp1)) -
      ...
      c[i][j][2][0] =
          -dt * tx2 * (-(u[i - 1][j][k][1] * u[i - 1][j][k][2]) * tmp2) -
      ...
      c[i][j][3][0] =
          -dt * tx2 * (-(u[i - 1][j][k][1] * u[i - 1][j][k][3]) * tmp2) -
      ...
      c[i][j][4][0] =
          -dt * tx2 * ((C2 * (u[i - 1][j][k][1] * u[i - 1][j][k][1] +
                              u[i - 1][j][k][2] * u[i - 1][j][k][2] +
                              u[i - 1][j][k][3] * u[i - 1][j][k][3]) *
                            tmp2 -
                        C1 * (u[i - 1][j][k][4] * tmp1)) *
                       (u[i - 1][j][k][1] * tmp1)) -
          dt * tx1 * (-(r43 * c34 - c1345) * tmp3 * (pow2(u[i - 1][j][k][1])) -
      ...
      c[i][j][4][1] =
          -dt * tx2 *
              (C1 * (u[i - 1][j][k][4] * tmp1) -
               0.50 * C2 * ((3.0 * u[i - 1][j][k][1] * u[i - 1][j][k][1] +
                             u[i - 1][j][k][2] * u[i - 1][j][k][2] +
                             u[i - 1][j][k][3] * u[i - 1][j][k][3]) *
                            tmp2)) -
          dt * tx1 * (r43 * c34 - c1345) * tmp2 * u[i - 1][j][k][1];
      c[i][j][4][2] =
          -dt * tx2 * (-C2 * (u[i - 1][j][k][2] * u[i - 1][j][k][1]) * tmp2) -
          dt * tx1 * (c34 - c1345) * tmp2 * u[i - 1][j][k][2];
      c[i][j][4][3] =
          -dt * tx2 * (-C2 * (u[i - 1][j][k][3] * u[i - 1][j][k][1]) * tmp2) -
          dt * tx1 * (c34 - c1345) * tmp2 * u[i - 1][j][k][3];
      c[i][j][4][4] = -dt * tx2 * (C1 * (u[i - 1][j][k][1] * tmp1)) -
...
#pragma omp for nowait schedule(static)
  ...
  for (i = ist; i <= iend; i++) {
    for (j = jst; j <= jend; j++) {
      ...
      a[i][j][1][0] =
          dt * tx2 * (-(u[i + 1][j][k][1] * tmp1) * (u[i + 1][j][k][1] * tmp1) +
                      C2 * 0.50 * (u[i + 1][j][k][1] * u[i + 1][j][k][1] +
                                   u[i + 1][j][k][2] * u[i + 1][j][k][2] +
                                   u[i + 1][j][k][3] * u[i + 1][j][k][3]) *
                          tmp2) -
          dt * tx1 * (-r43 * c34 * tmp2 * u[i + 1][j][k][1]);
      a[i][j][1][1] = dt * tx2 * ((2.0 - C2) * (u[i + 1][j][k][1] * tmp1)) -
                      dt * tx1 * (r43 * c34 * tmp1) - dt * tx1 * dx2;
      ...
      a[i][j][4][3] =
          dt * tx2 * (-C2 * (u[i + 1][j][k][3] * u[i + 1][j][k][1]) * tmp2) -
          dt * tx1 * (c34 - c1345) * tmp2 * u[i + 1][j][k][3];
      a[i][j][4][4] = dt * tx2 * (C1 * (u[i + 1][j][k][1] * tmp1)) -
                      dt * tx1 * c1345 * tmp1 - dt * tx1 * dx5;
      ...
      b[i][j][2][0] =
          dt * ty2 * (-(u[i][j + 1][k][2] * tmp1) * (u[i][j + 1][k][2] * tmp1) +
                      0.50 * C2 * ((u[i][j + 1][k][1] * u[i][j + 1][k][1] +
                                    u[i][j + 1][k][2] * u[i][j + 1][k][2] +
                                    u[i][j + 1][k][3] * u[i][j + 1][k][3]) *
                                   tmp2)) -
      ...
      c[i][j][3][0] =
          dt * tz2 * (-(u[i][j][k + 1][3] * tmp1) * (u[i][j][k + 1][3] * tmp1) +
                      0.50 * C2 * ((u[i][j][k + 1][1] * u[i][j][k + 1][1] +
                                    u[i][j][k + 1][2] * u[i][j][k + 1][2] +
                                    u[i][j][k + 1][3] * u[i][j][k + 1][3]) *
                                   tmp2)) -
      ...
      c[i][j][3][3] = dt * tz2 * (2.0 - C2) * (u[i][j][k + 1][3] * tmp1) -
                      dt * tz1 * (r43 * c34 * tmp1) - dt * tz1 * dz4;
      c[i][j][3][4] = dt * tz2 * C2;
      ...
      c[i][j][4][0] =
          dt * tz2 * ((C2 * (u[i][j][k + 1][1] * u[i][j][k + 1][1] +
                       ...
                       C1 * (u[i][j][k + 1][4] * tmp1)) *
                      (u[i][j][k + 1][3] * tmp1)) -
          dt * tz1 * (-(c34 - c1345) * tmp3 * (pow2(u[i][j][k + 1][1])) -
          ...
          dt * tz2 *
              (C1 * (u[i][j][k + 1][4] * tmp1) -
               0.50 * C2 * ((u[i][j][k + 1][1] * u[i][j][k + 1][1] +
                            ...
                            tmp2)) -
          dt * tz1 * (r43 * c34 - c1345) * tmp2 * u[i][j][k + 1][3];
      c[i][j][4][4] = dt * tz2 * (C1 * (u[i][j][k + 1][3] * tmp1)) -
                      dt * tz1 * c1345 * tmp1 - dt * tz1 * dz5;
    }
  }
}
...
static void pintgr(void) {
  ...
  for (i = ibeg; i <= ifin; i++) {
    ...
    for (j = jbeg; j <= jfin; j++) {
      ...
      phi1[i][j] = C2 * (u[i][j][k][4] -
                         0.50 * (pow2(u[i][j][k][1]) + pow2(u[i][j][k][2]) +
                                 pow2(u[i][j][k][3])) /
                             u[i][j][k][0]);
  ...
  for (i = ibeg; i <= ifin1; i++) {
    for (j = jbeg; j <= jfin1; j++) {
      frc1 = frc1 + (phi1[i][j] + phi1[i + 1][j] + phi1[i][j + 1] +
                     phi1[i + 1][j + 1] + phi2[i][j] + phi2[i + 1][j] +
  ...
  if (jglob == ji1) {
    for (i = ibeg; i <= ifin; i++) {
      ...
      for (k = ki1; k <= ki2; k++) {
        phi1[i][k] =
            C2 * (u[i][jbeg][k][4] -
                  0.50 * (pow2(u[i][jbeg][k][1]) + pow2(u[i][jbeg][k][2]) +
                          pow2(u[i][jbeg][k][3])) /
                      u[i][jbeg][k][0]);
      }
    }
  ...
  if (jglob == ji2) {
    for (i = ibeg; i <= ifin; i++) {
      ...
      for (k = ki1; k <= ki2; k++) {
        phi2[i][k] =
            C2 * (u[i][jfin][k][4] -
                  0.50 * (pow2(u[i][jfin][k][1]) + pow2(u[i][jfin][k][2]) +
                          pow2(u[i][jfin][k][3])) /
                      u[i][jfin][k][0]);
      }
    }
  ...
  for (i = ibeg; i <= ifin1; i++) {
    for (k = ki1; k <= ki2 - 1; k++) {
      frc2 = frc2 + (phi1[i][k] + phi1[i + 1][k] + phi1[i][k + 1] +
                     phi1[i + 1][k + 1] + phi2[i][k] + phi2[i + 1][k] +
  ...
  if (iglob == ii1) {
    for (j = jbeg; j <= jfin; j++) {
      ...
      for (k = ki1; k <= ki2; k++) {
        phi1[j][k] =
            C2 * (u[ibeg][j][k][4] -
                  0.50 * (pow2(u[ibeg][j][k][1]) + pow2(u[ibeg][j][k][2]) +
                          pow2(u[ibeg][j][k][3])) /
                      u[ibeg][j][k][0]);
      }
    }
  ...
  if (iglob == ii2) {
    for (j = jbeg; j <= jfin; j++) {
      ...
      for (k = ki1; k <= ki2; k++) {
        phi2[j][k] =
            C2 * (u[ifin][j][k][4] -
                  0.50 * (pow2(u[ifin][j][k][1]) + pow2(u[ifin][j][k][2]) +
                          pow2(u[ifin][j][k][3])) /
                      u[ifin][j][k][0]);
      }
    }
  ...
  for (j = jbeg; j <= jfin1; j++) {
    for (k = ki1; k <= ki2 - 1; k++) {
      frc3 = frc3 + (phi1[j][k] + phi1[j + 1][k] + phi1[j][k + 1] +
                     phi1[j + 1][k + 1] + phi2[j][k] + phi2[j + 1][k] +
...
static void read_input(void) {
  ...
  if (fp != NULL) {
    ...
    while (fgetc(fp) != '\n')
      ;
    fscanf(fp, "%lf%lf%lf%lf%lf", &tolrsd[0], &tolrsd[1], &tolrsd[2],
           &tolrsd[3], &tolrsd[4]);
    while (fgetc(fp) != '\n')
      ;
      ...
      for (k = 1; k <= nz - 2; k++) {
        ...
        for (i = ist; i <= L2; i++) {
          ...
          flux[i][j][k][4] =
              ...
              (1.0 / 6.0) * tx3 * (pow2(u21i) - pow2(u21im1)) +
              C1 * C5 * tx3 * (u51i - u51im1);
        }
        ...
        for (m = 0; m < 5; m++) {
          rsd[1][j][k][m] = rsd[1][j][k][m] -
                            dssp * (+5.0 * u[1][j][k][m] - 4.0 * u[2][j][k][m] +
                                    u[3][j][k][m]);
          rsd[2][j][k][m] = rsd[2][j][k][m] -
                            dssp * (-4.0 * u[1][j][k][m] + 6.0 * u[2][j][k][m] -
        ...
        for (m = 0; m < 5; m++) {
          rsd[nx - 3][j][k][m] =
              rsd[nx - 3][j][k][m] -
              dssp * (u[nx - 5][j][k][m] - 4.0 * u[nx - 4][j][k][m] +
                      6.0 * u[nx - 3][j][k][m] - 4.0 * u[nx - 2][j][k][m]);
          rsd[nx - 2][j][k][m] =
              rsd[nx - 2][j][k][m] -
              dssp * (u[nx - 4][j][k][m] - 4.0 * u[nx - 3][j][k][m] +
                      5.0 * u[nx - 2][j][k][m]);
        }
      }
    }
    ...
    for (i = ist; i <= iend; i++) {
      for (k = 1; k <= nz - 2; k++) {
        ...
        for (j = jst; j <= L2; j++) {
          ...
          flux[i][j][k][4] =
              0.50 * (1.0 - C1 * C5) * ty3 *
                  ((pow2(u21j) + pow2(u31j) + pow2(u41j)) -
                   (pow2(u21jm1) + pow2(u31jm1) + pow2(u41jm1))) +
              (1.0 / 6.0) * ty3 * (pow2(u31j) - pow2(u31jm1)) +
              C1 * C5 * ty3 * (u51j - u51jm1);
        }
        ...
        for (m = 0; m < 5; m++) {
          rsd[i][1][k][m] = rsd[i][1][k][m] -
                            dssp * (+5.0 * u[i][1][k][m] - 4.0 * u[i][2][k][m] +
                                    u[i][3][k][m]);
          rsd[i][2][k][m] = rsd[i][2][k][m] -
                            dssp * (-4.0 * u[i][1][k][m] + 6.0 * u[i][2][k][m] -
        ...
        for (m = 0; m < 5; m++) {
          rsd[i][ny - 3][k][m] =
              rsd[i][ny - 3][k][m] -
              dssp * (u[i][ny - 5][k][m] - 4.0 * u[i][ny - 4][k][m] +
                      6.0 * u[i][ny - 3][k][m] - 4.0 * u[i][ny - 2][k][m]);
          rsd[i][ny - 2][k][m] =
              rsd[i][ny - 2][k][m] -
              dssp * (u[i][ny - 4][k][m] - 4.0 * u[i][ny - 3][k][m] +
                      5.0 * u[i][ny - 2][k][m]);
        }
      }
    }
    ...
    for (i = ist; i <= iend; i++) {
      for (j = jst; j <= jend; j++) {
        ...
        for (k = 1; k <= nz - 1; k++) {
          ...
          flux[i][j][k][4] =
              0.50 * (1.0 - C1 * C5) * tz3 *
                  ((pow2(u21k) + pow2(u31k) + pow2(u41k)) -
                   (pow2(u21km1) + pow2(u31km1) + pow2(u41km1))) +
              (1.0 / 6.0) * tz3 * (pow2(u41k) - pow2(u41km1)) +
              C1 * C5 * tz3 * (u51k - u51km1);
        }
        ...
        for (m = 0; m < 5; m++) {
          rsd[i][j][1][m] = rsd[i][j][1][m] -
                            dssp * (+5.0 * u[i][j][1][m] - 4.0 * u[i][j][2][m] +
                                    u[i][j][3][m]);
          rsd[i][j][2][m] = rsd[i][j][2][m] -
                            dssp * (-4.0 * u[i][j][1][m] + 6.0 * u[i][j][2][m] -
        ...
        for (m = 0; m < 5; m++) {
          rsd[i][j][nz - 3][m] =
              rsd[i][j][nz - 3][m] -
              dssp * (u[i][j][nz - 5][m] - 4.0 * u[i][j][nz - 4][m] +
                      6.0 * u[i][j][nz - 3][m] - 4.0 * u[i][j][nz - 2][m]);
          rsd[i][j][nz - 2][m] =
              rsd[i][j][nz - 2][m] -
              dssp * (u[i][j][nz - 4][m] - 4.0 * u[i][j][nz - 3][m] +
                      5.0 * u[i][j][nz - 2][m]);
        }
      }
    }
...
#pragma omp barrier
      ...
      for (k = nz - 2; k >= 1; k--) {
        ...
        --------------------------------------------------------------------*/
        buts(nx, ny, nz, k, omega, rsd, tv, d, a, b, c, ist, iend, jst, jend,
             nx0, ny0);
      }
#pragma omp barrier
...
static void verify(double xcr[5], double xce[5], double xci, char *class,
  ...
  double xcrref[5], xceref[5], xciref, xcrdif[5], xcedif[5], xcidif, epsilon,
      dtref;
  int m;
  ...
  *verified = TRUE;
  ...
  if (nx0 == 12 && ny0 == 12 && nz0 == 12 && itmax == 50) {
    *class = 'S';
    ...
    /*--------------------------------------------------------------------
    c   Reference values of RMS-norms of solution error, for the (12X12X12)
    grid,
    c   after 50 time steps, with  DT = 5.0d-01
    --------------------------------------------------------------------*/
    ...
    *class = 'W'; /* SPEC95fp size */
    ...
    /*--------------------------------------------------------------------
    c   Reference values of RMS-norms of solution error, for the (33X33X33)
    grid,
    --------------------------------------------------------------------*/
    ...
    *class = 'A';
    ...
    /*--------------------------------------------------------------------
    c   Reference values of RMS-norms of solution error, for the (64X64X64)
    grid,
    c   after 250 time steps, with  DT = 2.0d+0.0
    --------------------------------------------------------------------*/
