...
void fft_twiddle_gen1(COMPLEX *in, COMPLEX *out, COMPLEX *W, int r, int m,
...
void fft_twiddle_2_seq(int a, int b, COMPLEX *in, COMPLEX *out, COMPLEX *W,
...
void fft_twiddle_4_seq(int a, int b, COMPLEX *in, COMPLEX *out, COMPLEX *W,
                       int nW, int nWdn, int m) {
  int l1, i;
  COMPLEX *jp, *kp;
  REAL tmpr, tmpi, wr, wi;
...
void fft_twiddle_8_seq(int a, int b, COMPLEX *in, COMPLEX *out, COMPLEX *W,
                       int nW, int nWdn, int m) {
  int l1, i;
  COMPLEX *jp, *kp;
  REAL tmpr, tmpi, wr, wi;
...
void fft_twiddle_16_seq(int a, int b, COMPLEX *in, COMPLEX *out, COMPLEX *W,
                        int nW, int nWdn, int m) {
  int l1, i;
  COMPLEX *jp, *kp;
  REAL tmpr, tmpi, wr, wi;
...
void fft_twiddle_32_seq(int a, int b, COMPLEX *in, COMPLEX *out, COMPLEX *W,
                        int nW, int nWdn, int m) {
  int l1, i;
  COMPLEX *jp, *kp;
  REAL tmpr, tmpi, wr, wi;
...
void fft_aux_seq(int n, COMPLEX *in, COMPLEX *out, int *factors, COMPLEX *W,
                 int nW) {
  int r, m;
  int k;
...
int test_correctness(int n, COMPLEX *out1, COMPLEX *out2) {
  ...
  for (i = 0; i < n; ++i) {
    a = sqrt((c_re(out1[i]) - c_re(out2[i])) * (c_re(out1[i]) - c_re(out2[i])) +
