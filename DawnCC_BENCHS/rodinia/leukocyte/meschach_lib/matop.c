...
#ifndef ANSI_C
MAT *m_add(mat1, mat2, out) MAT *mat1, *mat2, *out;
#else
...
#ifndef ANSI_C
MAT *m_sub(mat1, mat2, out) MAT *mat1, *mat2, *out;
#else
...
#ifndef ANSI_C
MAT *mmtr_mlt(A, B, OUT) MAT *A, *B, *OUT;
#else
...
#ifndef ANSI_C
MAT *mtrm_mlt(A, B, OUT) MAT *A, *B, *OUT;
#else
...
#ifndef ANSI_C
MAT *sm_mlt(scalar, matrix, out) double scalar;
MAT *matrix, *out;
#else
...
#ifndef ANSI_C
MAT *m_transp(in, out) MAT *in, *out;
#else
...
#ifndef ANSI_C
MAT *swap_rows(A, i, j, lo, hi) MAT *A;
int i, j, lo, hi;
#else
...
#ifndef ANSI_C
MAT *swap_cols(A, i, j, lo, hi) MAT *A;
int i, j, lo, hi;
#else
...
/* ms_mltadd -- matrix-scalar multiply and add
        ...
        -- returns out == A1 + s*A2 */
#ifndef ANSI_C
MAT *ms_mltadd(A1, A2, s, out) MAT *A1, *A2, *out;
double s;
#else
...
#ifndef ANSI_C
VEC *mv_mltadd(v1, v2, A, alpha, out) VEC *v1, *v2, *out;
MAT *A;
double alpha;
#else
VEC *mv_mltadd(const VEC *v1, const VEC *v2, const MAT *A, double alpha,
               VEC *out)
#endif
{
  /* register	int	j; */
...
/* vm_mltadd -- vector-matrix multiply and add
        ...
        -- returns out' == v1' + v2'*A */
#ifndef ANSI_C
VEC *vm_mltadd(v1, v2, A, alpha, out) VEC *v1, *v2, *out;
MAT *A;
double alpha;
#else
VEC *vm_mltadd(const VEC *v1, const VEC *v2, const MAT *A, double alpha,
               VEC *out)
#endif
{
  int /* i, */ j, m, n;
