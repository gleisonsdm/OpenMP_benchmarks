...
void lanczos(A_fn, A_params, m, x0, a, b, beta2, Q) VEC *(
    *A_fn)(); /* VEC *(*A_fn)(void *A_params,VEC *in, VEC *out) */
void *A_params;
int m;
VEC *x0, *a, *b;
Real *beta2;
...
VEC *lanczos2(A_fn, A_params, m, x0, evals, err_est) VEC *(*A_fn)();
void *A_params;
int m;
...
void sp_lanczos(A, m, x0, a, b, beta2, Q) SPMAT *A;
int m;
VEC *x0, *a, *b;
Real *beta2;
MAT *Q;
...
/* sp_lanczos2 -- version of lanczos2() that uses sparse matrix data
                                        structure */
VEC *sp_lanczos2(A, m, x0, evals, err_est) SPMAT *A;
int m;
VEC *x0;      /* initial vector */
VEC *evals;   /* eigenvalue vector */
VEC *err_est; /* error estimates of eigenvalues */
