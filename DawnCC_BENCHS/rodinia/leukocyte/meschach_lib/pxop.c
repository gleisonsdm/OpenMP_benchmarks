...
#ifndef ANSI_C
PERM *px_inv(px, out) PERM *px, *out;
#else
...
#ifndef ANSI_C
PERM *px_mlt(px1, px2, out) PERM *px1, *px2, *out;
#else
...
#ifndef ANSI_C
VEC *px_vec(px, vector, out) PERM *px;
VEC *vector, *out;
#else
...
#ifndef ANSI_C
VEC *pxinv_vec(px, x, out) PERM *px;
VEC *x, *out;
#else
...
#ifndef ANSI_C
PERM *px_transp(px, i1, i2) PERM *px; /* permutation to transpose */
...
#ifndef ANSI_C
static int myqsort(a, num) int *a, num;
#else
