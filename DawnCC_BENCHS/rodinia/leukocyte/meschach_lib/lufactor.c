...
#ifndef ANSI_C
VEC *LUsolve(LU, pivot, b, x) MAT *LU;
PERM *pivot;
VEC *b, *x;
#else
...
#ifndef ANSI_C
VEC *LUTsolve(LU, pivot, b, x) MAT *LU;
PERM *pivot;
VEC *b, *x;
#else
...
#ifndef ANSI_C
double LUcondest(LU, pivot) MAT *LU;
PERM *pivot;
#else
...
#endif
{
  ...
  catch (E_SING, LTsolve(LU, y, y, 1.0); LUsolve(LU, pivot, y, z);
         , return HUGE_VAL);
