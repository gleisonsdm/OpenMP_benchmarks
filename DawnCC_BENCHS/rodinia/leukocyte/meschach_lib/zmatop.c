...
ZMAT *zm_add(mat1, mat2, out) ZMAT *mat1, *mat2, *out;
{
  unsigned int m, n, i;
...
ZMAT *zm_sub(mat1, mat2, out) ZMAT *mat1, *mat2, *out;
{
  unsigned int m, n, i;
...
ZMAT *zm_mlt(A, B, OUT) ZMAT *A, *B, *OUT;
{
...
ZMAT *zmma_mlt(A, B, OUT) ZMAT *A, *B, *OUT;
{
  int i, j, limit;
...
ZMAT *zmam_mlt(A, B, OUT) ZMAT *A, *B, *OUT;
{
  int i, k, limit;
...
ZMAT *zsm_mlt(scalar, matrix, out) complex scalar;
ZMAT *matrix, *out;
{
  unsigned int m, n, i;
...
ZMAT *zm_adjoint(in, out) ZMAT *in, *out;
{
  int i, j;
  int in_situ;
  complex tmp;
...
ZMAT *zswap_rows(A, i, j, lo, hi) ZMAT *A;
int i, j, lo, hi;
{
  int k;
  complex **A_me, tmp;
...
ZMAT *zswap_cols(A, i, j, lo, hi) ZMAT *A;
int i, j, lo, hi;
{
  int k;
  complex **A_me, tmp;
  ...
  AI1[0] = j * 8;
  AI1[1] = i * 8;
  AI1[2] = A_me[AI1[0]] < A_me[AI1[1]];
  AI1[3] = (AI1[2] ? A_me[AI1[0]] : A_me[AI1[1]]);
  AI1[4] = A_me[AI1[0]] < AI1[3];
  AI1[5] = (AI1[4] ? A_me[AI1[0]] : AI1[3]);
  AI1[6] = AI1[5] / 40;
  AI1[7] = (AI1[6] > 0);
  AI1[8] = (AI1[7] ? AI1[6] : 0);
  AI1[9] = A_me[AI1[0]] > A_me[AI1[1]];
  AI1[10] = (AI1[9] ? A_me[AI1[0]] : A_me[AI1[1]]);
  AI1[11] = A_me[AI1[0]] > AI1[10];
  AI1[12] = (AI1[11] ? A_me[AI1[0]] : AI1[10]);
  AI1[13] = (long long int) AI1[12];
  AI1[14] = AI1[13] + 40;
  AI1[15] = AI1[14] / 40;
  AI1[16] = (AI1[15] > 0);
  ...
  AI1[20] = AI1[8] + AI1[18];
  AI1[21] = -1 * AI1[18];
  AI1[22] = AI1[19] ? AI1[8] : AI1[20];
  AI1[23] = AI1[19] ? AI1[18] : AI1[21];
  #pragma omp target data map(to: A[AI1[22]:AI1[23]]) 
  #pragma omp target
  for (k = lo; k <= hi; k++) {
    tmp = A_me[i][k];
    A_me[i][k] = A_me[j][k];
...
/* mz_mltadd -- matrix-scalar multiply and add
   -- may be in situ
   -- returns out == A1 + s*A2 */
ZMAT *mz_mltadd(A1, A2, s, out) ZMAT *A1, *A2, *out;
complex s;
{
...
ZVEC *zmv_mltadd(v1, v2, A, alpha, out) ZVEC *v1, *v2, *out;
ZMAT *A;
complex alpha;
{
  /* register	int	j; */
...
/* zvm_mltadd -- vector-matrix multiply and add a la zvm_mlt()
   -- may not be in situ
   -- returns out == v1 + v2*.A */
ZVEC *zvm_mltadd(v1, v2, A, alpha, out) ZVEC *v1, *v2, *out;
ZMAT *A;
complex alpha;
{
  int /* i, */ j, m, n;
...
ZVEC *zget_col(mat, col, vec) int col;
ZMAT *mat;
ZVEC *vec;
{
  unsigned int i;
...
ZVEC *zget_row(mat, row, vec) int row;
ZMAT *mat;
ZVEC *vec;
{
  int /* i, */ lim;
...
ZMAT *zset_col(mat, col, vec) ZMAT *mat;
ZVEC *vec;
int col;
{
  unsigned int i, lim;
...
ZMAT *zset_row(mat, row, vec) ZMAT *mat;
ZVEC *vec;
int row;
{
  unsigned int /* j, */ lim;
