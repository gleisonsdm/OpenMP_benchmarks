...
#ifndef ANSI_C
double _in_prod(a, b, i0) VEC *a, *b;
unsigned int i0;
#else
...
/* sv_mlt -- scalar-vector multiply -- out <- scalar*vector
        -- may be in-situ */
#ifndef ANSI_C
VEC *sv_mlt(scalar, vector, out) double scalar;
VEC *vector, *out;
#else
...
#ifndef ANSI_C
VEC *v_add(vec1, vec2, out) VEC *vec1, *vec2, *out;
#else
...
/* v_mltadd -- scalar/vector multiplication and addition
                -- out = v1 + scale.v2		*/
#ifndef ANSI_C
VEC *v_mltadd(v1, v2, scale, out) VEC *v1, *v2, *out;
double scale;
#else
...
#ifndef ANSI_C
VEC *v_sub(vec1, vec2, out) VEC *vec1, *vec2, *out;
#else
...
#ifndef ANSI_C
VEC *_v_map(f, params, x, out) double (*f)();
void *params;
VEC *x, *out;
#else
#ifdef PROTOTYPES_IN_STRUCT
...
#ifndef ANSI_C
VEC *v_lincomb(n, v, a, out) int n; /* number of a's and v's */
Real a[];
VEC *v[], *out;
#else
...
#ifndef ANSI_C
VEC *v_star(x1, x2, out) VEC *x1, *x2, *out;
#else
...
/* v_slash -- computes componentwise ratio of x2 and x1
        ...
        -- result out is returned */
#ifndef ANSI_C
VEC *v_slash(x1, x2, out) VEC *x1, *x2, *out;
#else
...
#ifndef ANSI_C
VEC *v_conv(x1, x2, out) VEC *x1, *x2, *out;
#else
...
#ifndef ANSI_C
VEC *v_pconv(x1, x2, out) VEC *x1, *x2, *out;
#else
