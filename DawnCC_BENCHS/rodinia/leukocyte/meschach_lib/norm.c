...
#ifndef ANSI_C
double _v_norm1(x, scale) VEC *x, *scale;
#else
...
#ifndef ANSI_C
double _v_norm2(x, scale) VEC *x, *scale;
#else
...
#ifndef ANSI_C
double _v_norm_inf(x, scale) VEC *x, *scale;
#else
