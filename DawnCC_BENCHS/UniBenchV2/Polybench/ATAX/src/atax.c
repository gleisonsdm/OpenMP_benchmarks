...
void init_array(DATA_TYPE *x, DATA_TYPE *A) {
  ...
  #pragma omp target data map(tofrom: A[0:67108864],x[0:8192]) if(!RST_AI1)
...
void compareResults(DATA_TYPE *z, DATA_TYPE *z_outputFromGpu) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (z + 0) > (void*) (z_outputFromGpu + 8192))
  || ((void*) (z_outputFromGpu + 0) > (void*) (z + 8192)));
  #pragma omp target data map(to: z[0:8192],z_outputFromGpu[0:8192])  if(!RST_AI1)
  #pragma omp target if(!RST_AI1)
  for (i = 0; i < NY; i++) {
...
void atax_cpu(DATA_TYPE *A, DATA_TYPE *x, DATA_TYPE *y, DATA_TYPE *tmp) {
  ...
  #pragma omp target data map(tofrom: A[0:67108864],tmp[0:8192],x[0:8192],y[0:8192]) if(!RST_AI1)
  #pragma omp target if(!RST_AI1)
  for (i = 0; i < NY; i++) {
    y[i] = 0;
  }
  ...
  char RST_AI2 = 0;
  RST_AI2 |= !(((void*) (A + 0) > (void*) (tmp + 8192))
  || ((void*) (tmp + 0) > (void*) (A + 67108864)));
  RST_AI2 |= !(((void*) (A + 0) > (void*) (x + 8192))
  || ((void*) (x + 0) > (void*) (A + 67108864)));
  RST_AI2 |= !(((void*) (A + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (A + 67108864)));
  RST_AI2 |= !(((void*) (tmp + 0) > (void*) (x + 8192))
  || ((void*) (x + 0) > (void*) (tmp + 8192)));
  RST_AI2 |= !(((void*) (tmp + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (tmp + 8192)));
  RST_AI2 |= !(((void*) (x + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (x + 8192)));
  #pragma omp target data map(to: A[0:67108864],x[0:8192]) map(tofrom: tmp[0:8192],y[0:8192]) if(!RST_AI2)
...
#pragma omp parallel for collapse(1)
  char RST_AI3 = 0;
  RST_AI3 |= !(((void*) (A + 0) > (void*) (tmp + 8192))
  || ((void*) (tmp + 0) > (void*) (A + 67108864)));
  RST_AI3 |= !(((void*) (A + 0) > (void*) (x + 8192))
  || ((void*) (x + 0) > (void*) (A + 67108864)));
  RST_AI3 |= !(((void*) (A + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (A + 67108864)));
  RST_AI3 |= !(((void*) (tmp + 0) > (void*) (x + 8192))
  || ((void*) (x + 0) > (void*) (tmp + 8192)));
  RST_AI3 |= !(((void*) (tmp + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (tmp + 8192)));
  RST_AI3 |= !(((void*) (x + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (x + 8192)));
  #pragma omp target data map(to: A[0:67108864],tmp[0:8192]) map(tofrom: x[0:8192],y[0:8192]) if(!RST_AI3)
