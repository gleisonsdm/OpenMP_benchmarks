...
void gesummv(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 67108864))
  || ((void*) (B + 0) > (void*) (A + 67108864)));
  ...
  RST_AI1 |= !(((void*) (B + 0) > (void*) (tmp + 8192))
  || ((void*) (tmp + 0) > (void*) (B + 67108864)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (x + 8192))
  || ((void*) (x + 0) > (void*) (B + 67108864)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (y + 8192))
  || ((void*) (y + 0) > (void*) (B + 67108864)));
  ...
  #pragma omp target data map(to: A[0:67108864],B[0:67108864],x[0:8192]) map(tofrom: tmp[0:8192],y[0:8192]) if(!RST_AI1)
...
void compareResults(DATA_TYPE *y, DATA_TYPE *y_outputFromGpu) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (y + 0) > (void*) (y_outputFromGpu + 8192))
  || ((void*) (y_outputFromGpu + 0) > (void*) (y + 8192)));
  #pragma omp target data map(to: y[0:8192],y_outputFromGpu[0:8192])  if(!RST_AI1)
  #pragma omp target if(!RST_AI1)
  for (i = 0; i < (N); i++) {
