...
void gramschmidt(DATA_TYPE *A, DATA_TYPE *R, DATA_TYPE *Q) {
  ...
  DATA_TYPE nrm;
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (Q + 262144))
  || ((void*) (Q + 0) > (void*) (A + 262144)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (R + 262144))
  || ((void*) (R + 0) > (void*) (A + 262144)));
  RST_AI1 |= !(((void*) (Q + 0) > (void*) (R + 262144))
  || ((void*) (R + 0) > (void*) (Q + 262144)));
  #pragma omp target data map(tofrom: A[0:262144],Q[0:262144],R[0:262144]) if(!RST_AI1)
...
void init_array(DATA_TYPE *A, DATA_TYPE *A2) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (A2 + 262144))
  || ((void*) (A2 + 0) > (void*) (A + 262144)));
  #pragma omp target data map(tofrom: A[0:262144],A2[0:262144]) if(!RST_AI1)
  #pragma omp target if(!RST_AI1)
  for (i = 0; i < M; i++) {
    for (j = 0; j < N; j++) {
...
void compareResults(DATA_TYPE *A, DATA_TYPE *A_outputFromGpu) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (A_outputFromGpu + 262144))
  || ((void*) (A_outputFromGpu + 0) > (void*) (A + 262144)));
  #pragma omp target data map(to: A[0:262144],A_outputFromGpu[0:262144])  if(!RST_AI1)
  #pragma omp target if(!RST_AI1)
  for (i = 0; i < M; i++) {
    for (j = 0; j < N; j++) {
