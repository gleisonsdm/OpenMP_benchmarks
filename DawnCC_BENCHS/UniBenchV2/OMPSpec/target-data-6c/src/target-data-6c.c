...
void vec_mult(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C) {
  ...
  char RST_AI2 = 0;
  RST_AI2 |= !(((void*) (A + 0) > (void*) (B + 8192))
  || ((void*) (B + 0) > (void*) (A + 8192)));
  RST_AI2 |= !(((void*) (A + 0) > (void*) (C + 8192))
  || ((void*) (C + 0) > (void*) (A + 8192)));
  RST_AI2 |= !(((void*) (B + 0) > (void*) (C + 8192))
  || ((void*) (C + 0) > (void*) (B + 8192)));
  #pragma omp target data map(to: A[0:8192],B[0:8192]) map(tofrom: C[0:8192]) if(!RST_AI2)
