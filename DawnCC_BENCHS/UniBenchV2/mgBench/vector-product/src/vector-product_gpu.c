...
void init_arrays(float *A, float *B) {
  int i;
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 1000))
  || ((void*) (B + 0) > (void*) (A + 1000)));
  #pragma omp target data map(tofrom: A[0:1000],B[0:1000]) if(!RST_AI1)
...
#pragma omp parallel for
    ...
    RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 1000))
    || ((void*) (B + 0) > (void*) (A + 1000)));
    RST_AI1 |= !(((void*) (A + 0) > (void*) (C + 1000))
    || ((void*) (C + 0) > (void*) (A + 1000)));
    RST_AI1 |= !(((void*) (B + 0) > (void*) (C + 1000))
    || ((void*) (C + 0) > (void*) (B + 1000)));
    #pragma omp target data map(to: A[0:1000],B[0:1000]) map(tofrom: C[0:1000]) if(!RST_AI1)
    #pragma omp target if(!RST_AI1)
    for (i = 0; i < SIZE; ++i) {
      C[i] = A[i] * B[i];
    }
...
void compareResults(float *A, float *A_outputFromGpu) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (A_outputFromGpu + 1000))
  || ((void*) (A_outputFromGpu + 0) > (void*) (A + 1000)));
  #pragma omp target data map(to: A[0:1000],A_outputFromGpu[0:1000])  if(!RST_AI1)
  #pragma omp target if(!RST_AI1)
  for (i = 0; i < SIZE; i++) {
